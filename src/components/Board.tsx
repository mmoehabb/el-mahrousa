...
const Board: React.FC<BoardProps> = ({ handleRoll, isMyTurn, sendAction, onTileClick }) => {
  ...
  return (
    <div className="relative p-1 sm:p-2 md:p-4 bg-egyptian-pattern rounded-lg shadow-2xl border-2 md:border-4 border-egyptian-gold aspect-square w-[1200px] max-w-none overflow-hidden">
      <div
