...
export const BOARD_DATA: Tile[] = [
  // Bottom Row
  { id: 0, name: 'GO', type: TileType.SPECIAL },
  {
    id: 1,
    name: 'Helwan',
  ...
  { id: 2, name: 'Sodfa', type: TileType.EVENT },
  {
    id: 3,
    name: 'El Marg',
    type: TileType.PROPERTY,
  ...
  { id: 4, name: 'Income Tax', type: TileType.TAX },
  { id: 5, name: 'Ramses Station', type: TileType.AIRPORT, price: 200 },
  {
    id: 6,
    name: 'Shoubra',
    type: TileType.PROPERTY,
  ...
  { id: 7, name: 'Hazak', type: TileType.EVENT },
  {
    id: 8,
    name: 'Ain Shams',
    type: TileType.PROPERTY,
  ...
  { id: 12, name: 'Electricity Company', type: TileType.UTILITY, price: 150 },
  {
    id: 13,
    name: 'Mohandeseen',
    type: TileType.PROPERTY,
  ...
  { id: 15, name: 'Cairo Station', type: TileType.AIRPORT, price: 200 },
  {
    id: 16,
    name: 'Heliopolis',
    type: TileType.PROPERTY,
  ...
  { id: 17, name: 'Sodfa', type: TileType.EVENT },
  {
    id: 18,
    name: 'Nasr City',
    type: TileType.PROPERTY,
  ...
  // Top Row
  { id: 20, name: 'Vacation', type: TileType.SPECIAL },
  {
    id: 21,
    name: 'Zamalek',
    type: TileType.PROPERTY,
  ...
  { id: 22, name: 'Hazak', type: TileType.EVENT },
  {
    id: 23,
    name: 'Garden City',
    type: TileType.PROPERTY,
  ...
  { id: 25, name: 'Giza Station', type: TileType.AIRPORT, price: 200 },
  {
    id: 26,
    name: 'Manial',
    type: TileType.PROPERTY,
  ...
  { id: 28, name: 'Water Company', type: TileType.UTILITY, price: 150 },
  {
    id: 29,
    name: 'El Hussein',
    type: TileType.PROPERTY,
  ...
  // Right Column
  { id: 30, name: 'Go To Prison', type: TileType.SPECIAL },
  {
    id: 31,
    name: 'New Cairo',
    type: TileType.PROPERTY,
  ...
  { id: 33, name: 'Sodfa', type: TileType.EVENT },
  {
    id: 34,
    name: 'Madinaty',
    type: TileType.PROPERTY,
  ...
  { id: 35, name: 'Monorail Station', type: TileType.AIRPORT, price: 200 },
  { id: 36, name: 'Hazak', type: TileType.EVENT },
  {
    id: 37,
    name: 'Sheikh Zayed',
    type: TileType.PROPERTY,
  ...
  { id: 38, name: 'Super Tax', type: TileType.TAX },
  {
    id: 39,
    name: 'New Capital',
    type: TileType.PROPERTY,
